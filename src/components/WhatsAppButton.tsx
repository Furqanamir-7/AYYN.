...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      <span className="pointer-events-none absolute bottom-full left-0 mb-2 hidden whitespace-nowrap rounded-full bg-charcoal px-3 py-1.5 text-xs text-cream opacity-0 shadow-soft transition group-hover:opacity-100 sm:block sm:left-auto sm:right-0">
      ...
      >
        ...
        <span className="text-xs font-medium tracking-wide sm:hidden">Chat</span>
      </a>
    </div>
  );
}
