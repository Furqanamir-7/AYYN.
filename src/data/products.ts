...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "Press-Ons",
    collectionId: "glaze-luxe",
    description: "Rosy chrome with gold french tips, tiny florals and gold leaf.",
    image: "/products/rose-muse.jpg",
    images: ["/products/rose-muse.jpg", "/products/rose-muse-2.jpg"],
    badges: ["Reusable", "Charms"],
    shapes: ["Almond", "Coffin"],
    waCollection: null,
    latest: true,
